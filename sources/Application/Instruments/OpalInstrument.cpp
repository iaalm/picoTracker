...
const char *const OpalInstrument::NAMES[OpalInstrument::kParamCount] = {
    /*  0 */ "InstrumentName",
    /*  1 */ "OPALInstrumentAlgorithm",
    /*  2 */ "OPALInstrumentFeedback",
    /*  3 */ "OPALInstrumentDeepTremeloVibrato",
    /*  4 */ "OPALInstrumentOp1Level",
    /*  5 */ "OPALInstrumentOp1Multiplier",
    /*  6 */ "OPALInstrumentOp1ADSR",
    /*  7 */ "OPALInstrumentOp1WaveShape",
    /*  8 */ "OPALInstrumentOp1KeyScaleLevel",
    /*  9 */ "OPALInstrumentOp1TremVibSusKSR",
    /* 10 */ "OPALInstrumentOp2Level",
    /* 11 */ "OPALInstrumentOp2Multiplier",
    /* 12 */ "OPALInstrumentOp2ADSR",
    /* 13 */ "OPALInstrumentOp2WaveShape",
    /* 14 */ "OPALInstrumentOp2KeyScaleLevel",
    /* 15 */ "OPALInstrumentOp2TremVibSusKSR",
};
