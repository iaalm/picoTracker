...
void InstrumentView::fillOpalParameters() {
  ...
  position._y += 1;
  paramBitmaskVarField_.emplace_back(UIParamBitmaskVarField(
      position, instrument, OpalInstrument::PARAM_DEEP_TREM_VIB,
      "Deep Trem/Vib: %02b", 2));
  ...
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position + GUIPoint(20, 0), instrument, OpalInstrument::PARAM_OP2_LEVEL,
      "%2.2X", 0, 63, 1, 1, 0));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, OpalInstrument::PARAM_OP1_MULTIPLIER,
      "Multiplier:    %1.1X", 0, 15, 1, 1, 0));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  paramIntVarField_.emplace_back(UIParamIntVarField(
      position + GUIPoint(20, 0), instrument,
      OpalInstrument::PARAM_OP2_MULTIPLIER, "%1.1X", 0, 15, 1, 1, 0));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  position._y += 1;
  paramBigHexVarField_.emplace_back(UIParamBigHexVarField(
      position, instrument, OpalInstrument::PARAM_OP1_ADSR, 4,
      "A/D/S/R:       %4.4X", 0, 0xFFFF, 16, true));
  fieldList_.insert(fieldList_.end(), &(*paramBigHexVarField_.rbegin()));
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, OpalInstrument::PARAM_OP1_WAVESHAPE,
      "Shape:         %s", 0, 7, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  paramIntVarField_.emplace_back(UIParamIntVarField(
      position + GUIPoint(20, 0), instrument,
      OpalInstrument::PARAM_OP2_WAVESHAPE, "%s", 0, 7, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  position._y += 1;
  paramBitmaskVarField_.emplace_back(UIParamBitmaskVarField(
      position, instrument, OpalInstrument::PARAM_OP1_TREM_VIB_SUS_KSR,
      "TR/VB/SU/KSR:  %04b", 4));
  fieldList_.insert(fieldList_.end(), &(*paramBitmaskVarField_.rbegin()));

  paramBitmaskVarField_.emplace_back(UIParamBitmaskVarField(
      position + GUIPoint(20, 0), instrument,
      OpalInstrument::PARAM_OP2_TREM_VIB_SUS_KSR, "%04b", 4));
  fieldList_.insert(fieldList_.end(), &(*paramBitmaskVarField_.rbegin()));

  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, OpalInstrument::PARAM_OP1_KEYSCALE,
      "Keyscale:      %s", 0, 3, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));
...
void InstrumentView::fillSynthParameters() {
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_FEEDBACK_OP,
      "fb op:    %1.1X", 0, 2, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));
  ...
  position._y += 1;
  // The legacy field used -64..63 for detune. The packed storage holds the
  // raw int; the SPECS[].min is 0 because detune is signed and the
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_FLT_CUTOFF,
      "cutoff:   %3.3X", 0, 0xFFF, 1, 0x10));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_FLT_KEYTRACK,
      "keytrack: %1.1X", 0, 0xF, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_FLT_ENV_DEPTH,
      "env dep:  %d", -128, 127, 1, 8));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));

  position._y += 1;
  paramBigHexVarField_.emplace_back(UIParamBigHexVarField(
      position, instrument, SynthInstrument::PARAM_FLT_ADSR, 4,
      "env ADSR: %4.4X", 0, 0xFFFF, 16, true));
  fieldList_.insert(fieldList_.end(), &(*paramBigHexVarField_.rbegin()));
  ...
  position._y += 1;
  paramBigHexVarField_.emplace_back(UIParamBigHexVarField(
      position, instrument, SynthInstrument::PARAM_PITCH_AD, 2,
      "env A/D:  %2.2X", 0, 0xFF, 16, true));
  fieldList_.insert(fieldList_.end(), &(*paramBigHexVarField_.rbegin()));
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_LFO_TARGET, "target: %s", 0,
      SYNTH_LFO_TGT_LAST - 1, 1, 1));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));
  ...
  position._y += 1;
  paramIntVarField_.emplace_back(UIParamIntVarField(
      position, instrument, SynthInstrument::PARAM_PORTAMENTO,
      "portamento: %2.2X", 0, 0xFF, 1, 0x10));
  fieldList_.insert(fieldList_.end(), &(*paramIntVarField_.rbegin()));
